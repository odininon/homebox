...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/repo.PriceHistoryEntry"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/repo.PriceHistoryCreate"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/entities/{id}/prices/auto-detect": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/v1/entities/{id}/prices/{price_id}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/pricing.ProductSearchResult"
                            }
                        }
                    }
                }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/repo.TagUpdate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "ent.Entity": {
            ...
            "properties": {
                ...
                "current_market_price": {
                    "description": "CurrentMarketPrice holds the value of the \"current_market_price\" field.",
                    "type": "number"
                },
                "description": {
                ...
                "last_price_sync_at": {
                    "description": "LastPriceSyncAt holds the value of the \"last_price_sync_at\" field.",
                    "type": "string"
                },
                "lifetime_warranty": {
                ...
                "price_tracking_enabled": {
                    "description": "PriceTrackingEnabled holds the value of the \"price_tracking_enabled\" field.",
                    "type": "boolean"
                },
                "price_tracking_id": {
                    "description": "PriceTrackingID holds the value of the \"price_tracking_id\" field.",
                    "type": "string"
                },
                "price_tracking_source": {
                    "description": "PriceTrackingSource holds the value of the \"price_tracking_source\" field.",
                    "type": "string"
                },
                "purchase_date": {
        ...
        "ent.EntityEdges": {
            ...
            "properties": {
                ...
                "price_history": {
                    "description": "PriceHistory holds the value of the price_history edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.EntityPriceHistory"
                    }
                },
                "tag": {
        ...
        "ent.EntityPriceHistory": {
            ...
            "properties": {
                ...
                "direct_low": {
                    "description": "DirectLow holds the value of the \"direct_low\" field.",
                    "type": "number"
                },
                "edges": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/ent.EntityPriceHistoryEdges"
                        }
                    ]
                },
                "entity_id": {
                ...
                "market_high": {
                    "description": "MarketHigh holds the value of the \"market_high\" field.",
                    "type": "number"
                },
                "market_low": {
                    "description": "MarketLow holds the value of the \"market_low\" field.",
                    "type": "number"
                },
                "market_mid": {
                    "description": "MarketMid holds the value of the \"market_mid\" field.",
                    "type": "number"
                },
                "notes": {
                    "description": "Notes holds the value of the \"notes\" field.",
                ...
                "recorded_at": {
                    "description": "RecordedAt holds the value of the \"recorded_at\" field.",
                    "type": "string"
                },
                "source": {
